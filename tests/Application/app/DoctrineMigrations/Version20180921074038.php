 ...
 */
final class Version20180921074038 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sylius_product (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, main_taxon_id INTEGER DEFAULT NULL, code VARCHAR(255) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, enabled BOOLEAN NOT NULL, variant_selection_method VARCHAR(255) NOT NULL COLLATE BINARY, average_rating DOUBLE PRECISION DEFAULT \'0\' NOT NULL, unit_of_measure VARCHAR(255) DEFAULT NULL, ritam_id INTEGER DEFAULT NULL, CONSTRAINT FK_677B9B74731E505 FOREIGN KEY (main_taxon_id) REFERENCES sylius_taxon (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
