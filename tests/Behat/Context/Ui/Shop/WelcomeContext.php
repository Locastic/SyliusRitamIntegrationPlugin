...
namespace Tests\Locastic\SyliusRitamIntegrationPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Locastic\SyliusRitamIntegrationPlugin\Behat\Page\Shop\WelcomePageInterface;
